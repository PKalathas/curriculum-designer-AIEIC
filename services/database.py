...
The Curriculum Designer owns editable curriculum drafts. The System
Orchestrator later publishes approved drafts into immutable lab packages.
"""
...
def json_type() -> Any:
    """Use JSONB on Postgres and generic JSON elsewhere for lightweight tests."""
